"""Offline ingestion CLI. Rebuilds the vector store from the configured sources.
Run on a schedule (cron / Airflow).

    python scripts/ingest.py data/seed
    python scripts/ingest.py data/seed --notion --slack
